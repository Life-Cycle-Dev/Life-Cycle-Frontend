              ...
              <div className="space-y-5">
                ...
                <div className="sticky flex justify-center">
                    <img src={userImgUrl ? userImgUrl : "asset/profile icon.png"} 
                         className={`${isUpload && "animate-pulse"} bottom-0 left-0 z-0 w-[30%] rounded-full`} />
                    <div className={`${isUpload && "animate-pulse"} cursor-pointer overflow-hidden absolute bottom-0 h-full z-10 bottom-0 z-0 w-[30%] rounded-full`}
